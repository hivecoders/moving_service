    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            Mover.objects.create(
                user=user,
                phone=form.cleaned_data.get('vehicle_type') if form.cleaned_data.get('has_vehicle') == 'Yes' else None,
                mover_type=form.cleanedget('phone'),
                vehicle_type=form.cleaned_data_data.get('mover_type'),
